...
public class JogoDaVelha {
    ...
    public void rodarJogo(){
        ...
        this.jogoDaVelha = new String[3][3];
        
        while (!sairJogo) {

            System.out.println("Você deseja jogar outra partida?(S/N)");
            this.sairJogoString = scanner.next();

            if (this.sairJogoString.equalsIgnoreCase("S")) {
                jogar();
            } else {
                this.sairJogo = true;
            }
